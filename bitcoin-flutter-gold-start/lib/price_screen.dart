...
class _PriceScreenState extends State<PriceScreen> {
  ...
  Column cardList() {
    ...
    for (String crypto in cryptoList) {
      cryptoCards.add(
        CryptoCard(
            value: ifWaiting ? '?' : cryptoCurrency[crypto],
            baseCryptoCurrency: crypto,
...
//            children: <Widget>[
//              CryptoCard(
//                  value: ifWaiting ? '?' : cryptoCurrency['BTC'],
//                  baseCryptoCurrency: 'BTC',
//                  selectedCurrency: selectedCurrency),
//              CryptoCard(
//                  value: ifWaiting ? '?' : cryptoCurrency['ETH'],
//                  baseCryptoCurrency: 'ETH',
//                  selectedCurrency: selectedCurrency),
//              CryptoCard(
//                  value: ifWaiting ? '?' : cryptoCurrency['LTC'],
//                  baseCryptoCurrency: 'LTC',
//                  selectedCurrency: selectedCurrency),
//            ],
//          ),
//          Container(
...
class CryptoCard extends StatelessWidget {
  const CryptoCard({
    Key key,
    @required this.value,
    @required this.baseCryptoCurrency,
    @required this.selectedCurrency,
  }) : super(key: key);

  final String value;
  final String selectedCurrency;
  final String baseCryptoCurrency;
    ...
    return Padding(
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Text(
            '1 $baseCryptoCurrency = $value $selectedCurrency',
